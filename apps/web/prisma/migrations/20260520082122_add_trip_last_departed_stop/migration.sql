...
CREATE TABLE "new_Trip" (
    ...
    CONSTRAINT "Trip_lastDepartedStopId_fkey" FOREIGN KEY ("lastDepartedStopId") REFERENCES "BusStop" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Trip" ("busId", "currentStopAt", "currentStopId", "direction", "driverId", "endedAt", "id", "lastLat", "lastLng", "lastSeenAt", "routeId", "startedAt", "status") SELECT "busId", "currentStopAt", "currentStopId", "direction", "driverId", "endedAt", "id", "lastLat", "lastLng", "lastSeenAt", "routeId", "startedAt", "status" FROM "Trip";
DROP TABLE "Trip";
